...
function main(pot_type, a, b, c, alpha, omega, d, T_l, gamma_l, tension, lambda, T, burn_in_time, 
    ...
    save(string("./data/", pot_type, "_trans_coef_seed", seed, "_a", a, "_b", b, "_c", c, "_alpha", alpha, 
		"_omega", omega, "_Tl", T_l, "_gamma_l", gamma_l, "_tension", tension, "_lambda", lambda, 
		"_d", d, "_T", T, "_burn", burn_in_time, "_dt", time_step, "_skip", skip,".jld"), "trans_coef", 
    	trans_coef, "running_trans_coef", running_trans_coef)
end
